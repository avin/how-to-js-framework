...
Этот курс создан для того, чтобы дать вам глубокое понимание того, как работают современные JS-фреймворки (React, Vue, Solid и др.). По мере прохождения уроков вы создадите свой собственный работающий фреймворк, который, хоть и не будет супер-производительным, покажет все ключевые концепции и решаемые проблемы.
...
1. Читайте уроки последовательно - каждый следующий основывается на предыдущем
2. Пишите код вместе с примерами - не просто читайте
3. Экспериментируйте - пробуйте изменять код и смотрите, что происходит
4. Выполняйте задания в конце каждого урока
5. Не торопитесь - важно понять концепции, а не просто скопировать код

## Требования

- Уверенное знание JavaScript (ES6+)
- Базовое понимание DOM API
- Опыт работы хотя бы с одним современным фреймворком (React, Vue, и т.д.) будет плюсом, но не обязателен

## Начать обучение

Приступайте к [Уроку 1: Введение](./lessons/01-introduction.md)

---

**Автор курса**: Создано для изучения внутреннего устройства современных JS-фреймворков
